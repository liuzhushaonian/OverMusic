...
//        super.getItemOffsets(outRect, view, parent, state);
        ...
        int defaultSpace=OverApplication.getContext().getResources().getDimensionPixelSize(R.dimen.default_space);

        int topSpace=OverApplication.getContext().getResources().getDimensionPixelSize(R.dimen.album_top);

        int other=OverApplication.getContext().getResources().getDimensionPixelSize(R.dimen.album_other);
